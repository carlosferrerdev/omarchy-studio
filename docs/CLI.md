...
- `audio`: user service states, package versions, successful PipeWire snapshot reachability, JACK package evidence, clock configuration, selected session defaults, and explicitly unavailable measurements.
